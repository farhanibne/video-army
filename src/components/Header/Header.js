...
const Header = () => {
  ...
  return (
    <div className="header">
      ...
      <div className="header__left" style={{marginTop:'5px'}}>
        {/* <Menu className="header__menuicon" /> */}
        <img style={{marginLeft:'10px'}} className="header__logo" src={logo} alt="Youtube" /> <h2 style={{marginLeft:'5px', textDecoration:'none'}}>Video Army</h2>
